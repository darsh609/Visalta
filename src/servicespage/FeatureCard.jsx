    ...
    <div className='w-full py-20 bg-[#D3D3CB] rounded-tl-3xl rounded-tr-3xl text-black'>
      ...
      <div className="cards w-full flex gap-10 mt-10">
            ...
            className="cardcontainer  relative w-1/2 h-[75vh]">
               <h1 className='absolute flex overflow-hidden right-0 translate-x-1/2 top-1/2 -translate-y-1/2 text-[#BCECE0] z-[10] font-["Founders_Grotesk_Condensed"] font-bold text-8xl leading-none tracking-tight uppercase'>
                    {"venueSmart".split('').map((item, index)=> (
                    <motion.span 
                    initial={{y:"100%"}} 
                    animate={cards[0]}
                ...
                className="cardcontainer relative w-1/2 h-[75vh]">
                <h1 className='absolute flex overflow-hidden right-full translate-x-1/2 top-1/2 -translate-y-1/2 text-[#BCECE0] z-[10] font-["Founders_Grotesk_Condensed"] font-bold text-8xl leading-none tracking-tight uppercase'>
